...
:::tip Experimental Feature for a pilot period.
...
If this returned `status` value is `successful`, you can trigger a capture without additional check for payment's state. 

This feature is experimental during a pilot period, so do not rely solely on it and still continue to check if payment was reserved. 
We are looking for your feedback during a pilot period if this brings value to your implementation having this experimental functionality.
