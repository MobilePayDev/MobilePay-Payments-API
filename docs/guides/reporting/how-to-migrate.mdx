...
This page contains information you need to know when migrating from [**Transaction Reporting API v1/v2**](https://mobilepaydev.github.io/MobilePay-TransactionReporting-API/index#overview) (v1 and v2) to newer and more stable [**Reporting API v3**](/docs/reporting/overview).
...
- Properties that were removed in response body:
    * `merchantId`
    * `merchantName`
